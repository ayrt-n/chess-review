...
public class MoveTextParserTests {
  ...
  void parsesSimpleMoveText() {
    ...
    List<String> parsedMoveText = MoveTextParser.parse(moveText);

    List<String> expectedList = Arrays.asList(
      "e4", "c5", "Nf3", "d6", "d4", "cxd4", "Nxd4", "Nf6", "Nc3", "a6",
      "Be2", "e5", "Nf3", "Be7", "O-O", "O-O", "a4", "h6", "Re1", "Be6",
      "h3", "Nbd7", "Be3", "Rc8", "a5", "Rxc3", "bxc3", "Nxe4", "Qb1", "Qc7",
      "Bf1", "Nxc3", "Qb2", "Rc8", "Nd2", "d5", "f3", "Bh4", "Rec1", "d4",
      "Bf2", "Bxf2", "Kxf2", "f5", "Qb4", "Nf6", "Kg1", "Nfd5", "Qc4", "Qe7",
      "Qb3", "Nf4", "Qb6", "Rc6", "Qa7", "Nfe2", "Bxe2", "Nxe2", "Kh1", "Nxc1",
      "Rxc1", "Qg5", "Rd1", "Rxc2", "Qb8", "Kh7", "Qxe5", "Rxd2", "Rxd2", "Qxd2"
    );

    assertEquals(expectedList, parsedMoveText);
  }
  ...
  void parsesMultilineMoveTextWithComments() {
    ...
    List<String> expectedList = Arrays.asList(
      ...
      "Re1", "b5", "Bb3", "O-O", "d4", "d6", "c3", "Bg4", "Be3", "exd4",
      "cxd4", "Na5", "Bc2", "c5", "dxc5", "dxc5", "h3", "Qxd1", "Bxd1", "Be6",
      "Nbd2", "Nc6", "Ng5", "c4", "a3", "Rad8", "Bc2", "Bc8", "f4", "Nd7",
      "Ngf3", "Nc5", "e5", "Nd3", "Bxd3", "Rxd3", "Ne4", "Bf5", "Nd6"
    );
